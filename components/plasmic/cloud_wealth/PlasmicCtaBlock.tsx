...
import sty from "./PlasmicCtaBlock.module.css"; // plasmic-import: JgQ-Rg7b-gm-q/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__yx3VR)}>
            <h2
          ...
          <div className={classNames(projectcss.all, sty.column__q0HAu)}>
            <Button
