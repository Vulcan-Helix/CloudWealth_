...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: 9v2sCEn_VLo5oT/component
import Select__Option from "../../Select__Option"; // plasmic-import: SZDI6Gk7qxE36l/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_cloud_wealth.module.css"; // plasmic-import: 7iST1GVY7MEDdpjnrPuCNJ/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: M5ZDc4iM9ViXlv/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: ycpSr62rPfk3yc/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: bqC_xznhSqB4sN/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__weo9U)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__ceAj3)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>
