...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: IieLbHG0mDkikF/css
...
function PlasmicTextInput__RenderFunc(props: {
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          placeholder: "Enter your email address here..." as const
        },
        props.args
      ),
    [props.args]
  ...
  return (
    ...
    >
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__ajhaO)}
                role={"img"}
              />
            ),
      ...
      <input
        ...
        name={"demo request form" as const}
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__clUeE)}
                role={"img"}
              />
            ),
