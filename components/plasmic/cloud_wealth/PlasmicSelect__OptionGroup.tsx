...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: t6p80aD9iXrmL1/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: M5ZDc4iM9ViXlv/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__pc9De)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___3N0V0)}
              />
            </React.Fragment>
          ),
          value: args.children
