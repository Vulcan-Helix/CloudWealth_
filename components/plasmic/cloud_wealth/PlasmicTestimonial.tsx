...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: a9WdLuxp3nOyM/css
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.column__aas8D)}>
        <h2
        ...
        >
          <div className={classNames(projectcss.all, sty.column__cmE)}>
            <p.PlasmicImg
              ...
              src={{
                src: "/plasmic/cloud_wealth/images/smalljpg.jpeg",
                fullWidth: 160,
                fullHeight: 160,
          ...
          <div className={classNames(projectcss.all, sty.column__paHy6)}>
            <h5
